...
\title[Random numerical semigroups]{Improved upper bounds on key invariants of Erdös-Rényi numerical semigroups} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Santiago Morales} % Your name
...
\medskip
\textit{moralesduarte@ucdavis.edu} % Your email address
}
